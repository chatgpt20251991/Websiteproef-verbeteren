...
SIZE = (2160, 3840)
REFERENCES = (
    ("original-website-reference.png", "image/png"),
    ("original-platform-reference.jpg", "image/jpeg"),
)

def run(validate_only=False):
    output = Path("sunburst-max-output")
    ...
    try:
        ...
        target = output / "startjouwautobedrijf-sunburst-max.png"
